...
```yaml
AIRFLOW__API_AUTH__JWT_SECRET: REMOVED_AIRFLOW_JWT_SECRET
AIRFLOW__API__SECRET_KEY: REMOVED_AIRFLOW_API_SECRET_KEY
AIRFLOW__CORE__FERNET_KEY: REMOVED_AIRFLOW_FERNET_KEY=
```
