...
OPTIONAL_PATHS = [
    ...
    Path("reports/latest_training_event_time_report.md"),
    Path("reports/latest_training_data_selection_experiment_report.md"),
    Path("reports/latest_training_data_selection_policy_report.md"),
